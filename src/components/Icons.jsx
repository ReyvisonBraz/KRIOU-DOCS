...
const icons = {
  ...
  // ─── Folder Icon — Seções de documentos ───
  Folder: (props) => (
    <svg
      {...props}
      viewBox="0 0 24 24"
  ...
  // ─── CheckCircle Icon — Confirmação de preenchimento ───
  CheckCircle: (props) => (
    <svg
      {...props}
      viewBox="0 0 24 24"
  ...
  // ─── Target Icon — Público-alvo / Objetivo ───
  Target: (props) => (
