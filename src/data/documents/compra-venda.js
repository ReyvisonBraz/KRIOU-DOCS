    ...
    },
    {
      ...
      fields: [
        field("valor_total", "Valor Total da Venda", "money", {
          ...
          hint: "Valor total combinado entre as partes para a venda do bem. Escreva o valor exato negociado.",
          whyImportant: "É a base de todo o contrato. Define o quanto o comprador deve pagar e protege ambas as partes em caso de disputa.",
        }),
        field("forma_pagamento", "Forma de Pagamento", "select", {
          required: true,
          options: ["À vista", "Parcelado", "Com Sinal + Parcelas", "Financiamento Bancário"],
          hint: "Como o valor será pago. 'À vista' = tudo de uma vez. 'Com Sinal' = um valor adiantado (entrada) + o resto depois. 'Financiamento' = através de um banco.",
          whyImportant: "Define como o dinheiro será pago e protege o comprador e o vendedor sobre prazos e condições.",
        }),
        field("valor_sinal", "Valor do Sinal (Arras)", "money", {
          required: false,
          placeholder: "R$ 0,00",
          example: "R$ 25.000,00",
          hint: "O 'Sinal' (ou 'Arras') é um valor pago como entrada para garantir o negócio. Se o comprador desistir, perde o sinal. Se o vendedor desistir, devolve o sinal em dobro.",
          whereFind: "Combinado entre as partes. Normalmente é de 10% a 30% do valor total da venda.",
          whyImportant: "Garante que ambas as partes estão compromissadas com o negócio. Funciona como uma 'multa' para quem desistir.",
          whatHappensIfEmpty: "O contrato será gerado sem cláusula de sinal. O pagamento será tratado conforme a forma escolhida acima.",
          disableable: true,
        }),
        field("condicoes_pagamento", "Condições de Pagamento", "textarea", {
          ...
          hint: "Detalhe aqui como o pagamento será feito: quantas parcelas, valores, datas e se será via PIX, transferência, cheque, etc.",
          whyImportant: "Sem detalhes claros de pagamento, podem surgir divergências futuras sobre datas e valores.",
          whatHappensIfEmpty: "O contrato mencionará apenas o valor total e a forma geral de pagamento, sem detalhar parcelas.",
          disableable: true,
        }),
      ],
    },
    {
      ...
      fields: [
        field("cidade_contrato", "Cidade do Contrato", "text", {
          ...
          hint: "Cidade onde o contrato será assinado pelas partes. Use o formato: Cidade, UF.",
        }),
        field("data_assinatura", "Data de Assinatura", "date", {
          required: true,
          hint: "Data em que o contrato será assinado por ambas as partes.",
        }),
        field("foro", "Foro (Comarca)", "text", {
          required: false,
          placeholder: "Comarca para resolução de conflitos",
          example: "Comarca de São Paulo/SP",
          hint: "'Foro' é o local (cidade) onde serão resolvidos problemas judiciais sobre este contrato. Normalmente é a mesma cidade do contrato.",
          whereFind: "Se não souber, use a mesma cidade onde o contrato será assinado.",
          whyImportant: "Define onde eventual processo judicial sobre o contrato será julgado. Evita que uma das partes precise se deslocar para outra cidade.",
          whatHappensIfEmpty: "O documento usará a cidade do contrato como foro.",
          disableable: true,
        }),
      ],
    },
    ...
    imovel: [
      {
        ...
        fields: [
          ...
          field("endereco_imovel", "Endereço do Imóvel", "text", {
            ...
            hint: "Endereço completo do imóvel que está sendo vendido, com rua, número e bairro.",
            whyImportant: "Identifica exatamente qual imóvel está sendo negociado. Deve coincidir com a escritura.",
          }),
          ...
          field("area_total", "Área Total (m²)", "text", {
            ...
            example: "120,00 m²",
            hint: "Área total do imóvel em metros quadrados. Use vírgula para decimais.",
            whereFind: "Escritura, carnê de IPTU ou certidão de matrícula do imóvel.",
            whatHappensIfEmpty: "O contrato será gerado sem mencionar a área. Recomendável informar para maior segurança.",
            disableable: true,
          }),
          ...
          field("possui_financiamento", "Possui Financiamento?", "select", {
            ...
            hint: "Informe se o imóvel tem ou teve financiamento bancário. 'Saldo devedor' significa que ainda há parcelas a pagar.",
            whyImportant: "Se há saldo devedor, o financiamento precisa ser quitado ou transferido antes da venda.",
            whatHappensIfEmpty: "O contrato será gerado sem menção a financiamento.",
            disableable: true,
          }),
        ],
      },
    ...
    veiculo: [
      {
        ...
        fields: [
          field("marca_modelo", "Marca / Modelo", "text", {
            ...
            hint: "Marca e modelo completo do veículo, exatamente como consta no documento.",
            whereFind: "CRLV (documento do carro — aquele verde/digital), nota fiscal de compra ou contrato anterior.",
          }),
          field("ano_fabricacao", "Ano de Fabricação", "text", {
            required: true,
            placeholder: "Ex: 2020",
            example: "2020",
            hint: "Ano em que o veículo foi fabricado na fábrica.",
            whereFind: "CRLV (documento do veículo). Aparece separado do ano do modelo.",
          }),
          field("ano_modelo", "Ano do Modelo", "text", {
            required: true,
            placeholder: "Ex: 2021",
            example: "2021",
            hint: "Ano do modelo do veículo. Pode ser diferente do ano de fabricação (ex: fabricado em 2020, modelo 2021).",
          ...
          field("cor", "Cor", "text", {
            ...
            example: "Prata",
            hint: "Cor do veículo conforme consta no documento. Use o nome exato (Prata, Branco, Preto, etc.).",
            whereFind: "CRLV (documento do veículo).",
          }),
          field("placa", "Placa", "text", {
            ...
            example: "ABC-1D23",
            hint: "Placa do veículo. Pode ser no formato antigo (ABC-1234) ou Mercosul (ABC1D23).",
            whereFind: "Na traseira do veículo ou no CRLV.",
            mask: "placa",
          }),
          field("chassi", "Número do Chassi", "text", {
            ...
            hint: "O chassi é como o 'CPF do veículo' — um número único com 17 caracteres (letras e números) que identifica o carro no mundo inteiro.",
            whereFind: "CRLV (documento do veículo), etiqueta na porta do motorista, gravado no painel (visível pelo para-brisa), ou na lateral do motor.",
            whyImportant: "O chassi é a principal forma de identificar um veículo. Garante que o carro sendo vendido é exatamente o descrito no contrato.",
          }),
          field("renavam", "RENAVAM", "text", {
            required: true,
            placeholder: "Ex: 00123456789",
            example: "00123456789",
            hint: "RENAVAM é o número de registro do veículo no sistema nacional de trânsito. Tem 11 dígitos e é como o 'número de cadastro' do carro no DETRAN.",
            whereFind: "CRLV (documento do veículo), na parte superior. Também aparece nos boletos de IPVA e multas.",
            whyImportant: "Necessário para consultar débitos, multas e fazer a transferência do veículo no DETRAN.",
          }),
          field("combustivel", "Combustível", "select", {
            required: false,
            options: ["Flex (Gasolina/Álcool)", "Gasolina", "Álcool", "Diesel", "Elétrico", "Híbrido"],
            hint: "Tipo de combustível que o veículo utiliza. 'Flex' aceita tanto gasolina quanto álcool.",
            whatHappensIfEmpty: "O contrato será gerado sem mencionar o combustível.",
            disableable: true,
          }),
          field("km_atual", "Quilometragem Atual", "text", {
            ...
            example: "45.000 km",
            hint: "Quilometragem marcada no painel do veículo no momento da venda.",
            whyImportant: "Registra o estado de uso do veículo no ato da venda. Protege ambas as partes contra fraudes.",
            whatHappensIfEmpty: "O contrato será gerado sem a quilometragem. É recomendável informar para segurança.",
            disableable: true,
          }),
        ],
      },
    ...
    terreno: [
      {
        ...
        fields: [
          field("endereco_terreno", "Localização do Terreno", "text", {
            ...
            hint: "Endereço ou identificação do terreno. Em loteamentos, use o número do lote e quadra. Em áreas rurais, use referências conhecidas.",
          }),
          ...
          field("medida_frente", "Medida da Frente (m)", "text", {
            ...
            whatHappensIfEmpty: "O contrato mencionará apenas a área total sem detalhar as medidas de cada lado.",
            disableable: true,
          }),
          field("medida_fundo", "Medida do Fundo (m)", "text", {
            ...
            whatHappensIfEmpty: "O contrato não mencionará a medida do fundo.",
            disableable: true,
          }),
          ...
          field("confrontantes", "Confrontantes (Vizinhos)", "textarea", {
            ...
            hint: "'Confrontantes' são os vizinhos ou limites em cada lado do terreno. Informe quem ou o quê faz divisa com cada lado.",
            whereFind: "Matrícula do imóvel no cartório ou planta do loteamento (que pode ser obtida na prefeitura ou com o loteador).",
            whatHappensIfEmpty: "O contrato será gerado sem informações de confrontação.",
            disableable: true,
          }),
          field("zoneamento", "Zoneamento", "select", {
            required: false,
            options: ["Residencial", "Comercial", "Misto", "Industrial", "Rural", "Não sei"],
            hint: "'Zoneamento' define o que pode ser construído no terreno conforme a lei municipal. 'Residencial' = só casas. 'Comercial' = lojas. 'Misto' = ambos.",
            whereFind: "Prefeitura da cidade, site de geoprocessamento municipal, ou planta do loteamento.",
            whatHappensIfEmpty: "O contrato será gerado sem informação de zoneamento.",
            disableable: true,
          }),
        ],
      },
  ...
  documentBody: {
    imovel: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "{?, No ato da assinatura deste instrumento, o(a) COMPRADOR(A) pagará a título de sinal e princípio de pagamento (arras) a quantia de {valor_sinal}.}",
          "{?, Condições complementares de pagamento: {condicoes_pagamento}.}",
        ],
      },
      {
        type: "clause",
    ...
    veiculo: [
      ...
      },
      {
        ...
        title: "DO OBJETO",
        paragraphs: [
          "O(A) VENDEDOR(A) vende ao(à) COMPRADOR(A) o veículo: {marca_modelo}, ano de fabricação {ano_fabricacao}, modelo {ano_modelo}, cor {cor}, placa {placa}, chassi n.º {chassi}, RENAVAM n.º {renavam}{?, , combustível: {combustivel}}{?, , quilometragem atual: {km_atual}}.",
        ],
      },
      {
        type: "clause",
        ...
        paragraphs: [
          "O preço total da venda é de {valor_total}, a ser pago na forma de {forma_pagamento}.",
          "{?, No ato da assinatura, o(a) COMPRADOR(A) pagará a título de sinal (arras) a quantia de {valor_sinal}.}",
          "{?, Condições complementares de pagamento: {condicoes_pagamento}.}",
        ],
      },
      {
    ...
    terreno: [
      ...
      },
      {
        ...
        number: "4ª",
        title: "DAS DECLARAÇÕES",
        text: "O(A) VENDEDOR(A) declara que o terreno está livre e desembaraçado de quaisquer ônus, dívidas ou gravames. As despesas com escritura, registro e impostos de transferência serão de responsabilidade do(a) COMPRADOR(A), salvo acordo em contrário entre as partes.",
      },
      {
        type: "clause",
        number: "5ª",
